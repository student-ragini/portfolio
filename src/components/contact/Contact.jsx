        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card-data">kriragini2728@gmail.com</span>

              <a href="mailto:kriragini2728@gmail.com" className="contact_button">
                Write me{" "}
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">rag_ini2728</span>

              <a
                href="https://www.instagram.com/rag_ini2728"
                className="contact_button"
                target="_blank"
                rel="noopener noreferrer"
              >
